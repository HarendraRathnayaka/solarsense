  ...
  const resources = [
    {
      ...
      link: 'https://drive.google.com/folder/example1',
      icon: ClipboardList,
    ...
    },
    {
      ...
      link: 'https://drive.google.com/folder/example2',
    ...
    },
    {
      ...
      link: 'https://drive.google.com/folder/example3',
      icon: PresentationIcon,
    ...
    },
    {
      ...
      link: 'https://drive.google.com/folder/example4',
      icon: FileArchive,
    ...
    },
    {
      ...
      link: 'https://drive.google.com/folder/example5',
      icon: BookOpen,
